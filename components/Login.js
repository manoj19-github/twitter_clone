        ...
        <div className="flex justify-center pt-10 items-center flex-col space-y-20">
            ...
            {Object.values(providers).map(provider=>(
              <div key={provider.name}>
                <a href="#" onClick={()=>handleClick(provider)} class="relative inline-flex items-center justify-center px-6 py-3 overflow-hidden font-bold text-white rounded-md shadow-2xl group">
